...
///@uniform {float} contrast
	...
	void main() {
		...
		vec2 fp = fract(inputTexture[0].xy * resolution);
    
		vec3 A1 = texture2D(gm_BaseTexture, inputTexture[1].xw).rgb;
		vec3 B1 = texture2D(gm_BaseTexture, inputTexture[1].yw).rgb;
		vec3 C1 = texture2D(gm_BaseTexture, inputTexture[1].zw).rgb;
    
		vec3 A  = texture2D(gm_BaseTexture, inputTexture[2].xw).rgb;
		vec3 B  = texture2D(gm_BaseTexture, inputTexture[2].yw).rgb;
		vec3 C  = texture2D(gm_BaseTexture, inputTexture[2].zw).rgb;
    
		vec3 D  = texture2D(gm_BaseTexture, inputTexture[3].xw).rgb;
		vec3 E  = texture2D(gm_BaseTexture, inputTexture[3].yw).rgb;
		vec3 F  = texture2D(gm_BaseTexture, inputTexture[3].zw).rgb;
    
		vec3 G  = texture2D(gm_BaseTexture, inputTexture[4].xw).rgb;
		vec3 H  = texture2D(gm_BaseTexture, inputTexture[4].yw).rgb;
		vec3 I  = texture2D(gm_BaseTexture, inputTexture[4].zw).rgb;
    
		vec3 G5 = texture2D(gm_BaseTexture, inputTexture[5].xw).rgb;
		vec3 H5 = texture2D(gm_BaseTexture, inputTexture[5].yw).rgb;
		vec3 I5 = texture2D(gm_BaseTexture, inputTexture[5].zw).rgb;
    
		vec3 A0 = texture2D(gm_BaseTexture, inputTexture[6].xy).rgb;
		vec3 D0 = texture2D(gm_BaseTexture, inputTexture[6].xz).rgb;
		vec3 G0 = texture2D(gm_BaseTexture, inputTexture[6].xw).rgb;
    
		vec3 C4 = texture2D(gm_BaseTexture, inputTexture[7].xy).rgb;
		vec3 F4 = texture2D(gm_BaseTexture, inputTexture[7].xz).rgb;
		vec3 I4 = texture2D(gm_BaseTexture, inputTexture[7].xw).rgb;
